      ...
      {vessel && (
        <>
          ...
          <div style={styles.body}>
            ...
            <Row label="Heading" value={vessel.heading != null && vessel.heading !== 511 ? `${vessel.heading}°` : 'Not available'} />
            <Row label="Vessel Type" value={describeVesselType(vessel.vesselType)} />
            <Row label="Last Updated" value={vessel.lastUpdated ? new Date(vessel.lastUpdated).toLocaleTimeString() : null} />
          </div>
        </>
      )}
    </div>
